                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                    <tr>
                      <td valign="top" class="headerContent">
                        <img src="http://gallery.mailchimp.com/2425ea8ad3/images/header_placeholder_600px.png"
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                    <tr>
                      <td valign="top" class="bodyContent">
                        ...
                        <h3>Anbei findest du die Abrechnung für {month}.</h3>
                        <br/>
                        <br/>
                        ...
                        <!-- BEGIN debts -->
                          <!-- IF debts.youOwe -->
                            Du schuldest {debts.user} {debts.debtSum}€.<br/>
                          <!-- ENDIF debts.youOwe -->
                          <!-- IF debts.theyOwe -->
                            {debts.user} schuldet dir {debts.debtSum}€.<br/>
                          <!-- ENDIF debts.theyOwe -->
                        <!-- END debts -->
                      </td>
                    </tr>
